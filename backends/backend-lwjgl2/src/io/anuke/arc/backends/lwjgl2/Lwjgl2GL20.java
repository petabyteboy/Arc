 ...
 * @author mzechner
 */
class Lwjgl2GL20 implements io.anuke.arc.graphics.GL20{
    ...
    private FloatBuffer toFloatBuffer(float[] v, int offset, int count){
        ...
        floatBuffer.clear();
        io.anuke.arc.util.BufferUtils.copy(v, floatBuffer, count, offset);
        return floatBuffer;
    }
    ...
    private IntBuffer toIntBuffer(int[] v, int offset, int count){
        ensureBufferCapacity(count << 2);
        intBuffer.clear();
        io.anuke.arc.util.BufferUtils.copy(v, count, offset, intBuffer);
        return intBuffer;
    }
